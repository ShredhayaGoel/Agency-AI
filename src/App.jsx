...
import Navbartemp1 from "./components/Navbartemp1";
const App = () => {
  ...
  return (
    <div className="dark:bg-black relative">
      <Toaster />
      <Navbartemp1 theme={theme} settheme={settheme} />
      <Hero />
      <TrustedBy />
      <Services />
      <OurWork />
      ...
      <div
       ...
       border-blue-200 pointer-events-none z-[9999]"
        style={{ transition: "transform 0.1s ease-out" }}
      ></div>
      {/*custom cursor dot */}
      <div
        ref={dotRef}
        className=" fixed top-0 left-0 h-3 w-3 rounded-full border 
            border-blue-200 pointer-events-none z-[9999]"
      ></div>
